    ...
    <div class="d-flex justify-content-between navbar-content align-items-center">
      <ul class="d-flex searchlistcontent align-items-center ps-1 mb-0">
        ...
        <li class="searchlist text-light" :class="{active:sideclose}">
          <div class="input-group search rounded-2 p-1">
            ...
            <button
              class="btn input-group-text border-0 bg-transparent shadow-none"
              id="basic-addon2"
            >
      ...
      <ul class="navicon d-flex justify-content-end iconcontent align-items-center mb-0">
        <li class="nav-item dropdown country">
          <a
            class="nav-link text-light bg-transparent dropdown-toggle"
            href="#"
            id="navbarDropdown"
            role="button"
            ...
            aria-expanded="false"
          >
            <img src="../assets/flagicon/united-states.png" style="width:24px" />
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <li>
              <a class="dropdown-item" href="#">
                <img src="../assets/flagicon/germany.png" style="width:24px" />
                <span>Deutsch</span>
              </a>
            </li>
            ...
            <li>
              <a class="dropdown-item" href="#">
                <img src="../assets/flagicon/spain.png" style="width:24px" />
                <span>Español</span>
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="#">
                <img src="../assets/flagicon/france.png" style="width:24px" />
                <span>Français</span>
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="#">
                <img src="../assets/flagicon/brazil.png" style="width:24px" />
...
.navbar-toggler-icon {
  filter: invert(100%) sepia(100%) saturate(1%) hue-rotate(289deg)
